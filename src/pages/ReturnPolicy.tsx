        ...
        <div className="bg-zinc-900 rounded-xl p-8 border border-green-600/20 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-green-600/10">
              ...
              <p className="text-gray-300 text-center text-sm">
                We'll inspect the vehicle and process your refund within 45 business days if all conditions are met.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 rounded-xl p-8 border border-zinc-700 mb-8">
          ...
          <div className="space-y-4 pl-11">
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                The odometer reading must not exceed 150 kilometers beyond what was recorded on the date of delivery (or any pre-agreed test-drive mileage limit stated in the purchase agreement).
              </p>
            </div>
        ...
        <div className="bg-zinc-900 rounded-xl p-8 border border-zinc-700 mb-8">
          ...
          <div className="space-y-4 pl-11">
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                If the vehicle passes inspection and meets all return conditions, SG Supercars Inc. will process a refund of the purchase price minus the 2% restocking fee, all applicable taxes and duties, shipping and transportation costs for returning the vehicle, costs for any damage, repairs, or missing parts, and any other costs associated with the return process within 45 business days of the vehicle's arrival back at SG Supercars Inc.'s designated location.
              </p>
            </div>
