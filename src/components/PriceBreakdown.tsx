          ...
          {showServiceDetails && (
            <div className="mt-3 bg-zinc-800 p-4 rounded-lg text-sm text-gray-300 border border-zinc-700 space-y-3">
              ...
              <ol className="list-decimal ml-5 space-y-2">
                <li>Costs we have to pay our in-house inspector to complete a detailed on-site inspection of your vehicle in Korea, to ensure it is "SG Supercars Approved" and eligible for our 3-day return policy.</li>
                {/* <li>Costs associated with performing all necessary modifications so your vehicle is road legal in Canada.</li> */}
                <li>Costs with securely transporting your vehicle in an enclosed truck to the Busan / Incheon port within Korea.</li>
                ...
                <li>
                Our end‑to‑end expertise—so you can sit back, relax, and watch your dream car make its way to you.
              </li>
